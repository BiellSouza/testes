...
export default function AdvancedDemo() {
  ...
  useEffect(() => {
    // Configure suas imagens aqui
    setImages([
      { itemImageSrc: imagem1, thumbnailImageSrc: imagem1, alt: "Imagem 1", title: "Título 1" },
      { itemImageSrc: imagem2, thumbnailImageSrc: imagem2, alt: "Imagem 2", title: "Título 2" },
